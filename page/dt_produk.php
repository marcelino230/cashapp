...
<section class="content">
    ...
    <a href="?pg=prdk&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblproduk order by id_produk asc");
                    $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tblproduk VALUES ('','$_POST[tipe_kartu]',
                '$_POST[harga]')");
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblproduk WHERE id_produk='$_GET[id]'"));
            if (isset($_POST['update'])) {

                mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tblproduk SET nama_produk='$_POST[tipe_kartu]',
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tblproduk WHERE id_produk='$_GET[id]'");
      echo "<script>window.location='home.php?pg=prdk&act=view'</script>";
      break;
