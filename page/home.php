...
<html>
  <head>
    ...
    <title>PENCATATAN PENGELOLAAN KEUANGAN</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg">Catatan Keuangan</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php
                  $profil = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from users where username = '$_SESSION[username]'"))
                  ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>PENERIMAAN DAN PENGELUARAN UANG</small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?pg=masuk&act=view"><i class="fa fa-check-square-o"></i> Pendapatan</a></li>
                <li><a href="?pg=keluar&act=view"><i class="fa fa-check-square-o"></i> Belanja</a></li>
                <li class="treeview">
              <a href="#">
                <i class="fa fa-users"></i>
                <span>Data User</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?pg=pggna&act=view"><i class="fa fa-check-square-o"></i> Data User</a></li>
               <!-- <li><a href="?pg=krywn&act=view"><i class="fa fa-check-square-o"></i> Data Karyawan</a></li> -->
              </ul>
            </li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?pg=transaksi&act=view"><i class="fa fa-check-square-o"></i> Transaksi</a></li>
              </ul>
            </li>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>CATATAN KEUANGAN</b>
        </div>
        <strong>Copyright &copy; 2021 <a href="#">Catatan Keuangan</a>.</strong>
      </footer>
