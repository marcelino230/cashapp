...
<section class="content">
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
                ...
                $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tbltransaksi (kd_transaksi,tgl,id_jeniskas,id_kasmasuk,id_kaskeluar,ket,nominal)
...
<!--/////////////////////////////////// kas masuk ///////////////////////////////// -->
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT tbltransaksi.*,tblkasmasuk.*,tblkasmasuk.nama as namamasuk, tblkaskeluar.*,
                    tblkaskeluar.nama as namakeluar, tbljeniskas.* FROM tbltransaksi LEFT  join tblkasmasuk  on tbltransaksi.id_kasmasuk=tblkasmasuk.id_kasmasuk LEFT join tblkaskeluar ON tblkaskeluar.id_kaskeluar=tbltransaksi.id_kaskeluar INNER JOIN
                    tbljeniskas ON tbltransaksi.id_jeniskas=tbljeniskas.id_jeniskas WHERE tbltransaksi.kd_transaksi='$_GET[id]'"));
            if (isset($_POST['update'])) {
              mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tbltransaksi SET tgl='$_POST[tgl]',id_jeniskas='$_POST[id_jeniskas]',
...
<!--/////////////////////////////////// kas masuk ///////////////////////////////// -->
    ...
    // PROSES HAPUS DATA transaksi //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tbltransaksi WHERE kd_transaksi='$_GET[id]'");
      echo "<script>window.location='home.php?pg=transaksi&act=view'</script>";
      break;
