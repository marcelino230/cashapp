...
<section class="content">
    ...
    <a href="?pg=masuk&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysql_query("SELECT * FROM tblkasmasuk order by id_kasmasuk asc");
                    $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysql_query("INSERT INTO tblkasmasuk VALUES ('','$_POST[nama]')");
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysql_fetch_array(mysql_query("SELECT * FROM tblkasmasuk WHERE id_kasmasuk='$_GET[id]'"));
            if (isset($_POST['update'])) {

                mysql_query("UPDATE tblkasmasuk SET nama='$_POST[nama]' WHERE id_kasmasuk='$_POST[id]'");
                echo "<script>window.location='home.php?pg=masuk&act=view'</script>";
          }
              ?>
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysql_query("DELETE FROM tblkasmasuk WHERE id_kasmasuk='$_GET[id]'");
      echo "<script>window.location='home.php?pg=masuk&act=view'</script>";
      break;
