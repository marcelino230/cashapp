...
<section class="content">
    ...
    <a href="?pg=keluar&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblkaskeluar order by id_kaskeluar asc");
                    $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tblkaskeluar VALUES ('','$_POST[nama]')");
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblkaskeluar WHERE id_kaskeluar='$_GET[id]'"));
            if (isset($_POST['update'])) {

                mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tblkaskeluar SET nama='$_POST[nama]' WHERE id_kaskeluar='$_POST[id]'");
                echo "<script>window.location='home.php?pg=keluar&act=view'</script>";
          }
              ?>
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tblkaskeluar WHERE id_kaskeluar='$_GET[id]'");
      echo "<script>window.location='home.php?pg=keluar&act=view'</script>";
      break;
