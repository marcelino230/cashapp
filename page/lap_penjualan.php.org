      ...
      <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                      ...
                      <table class="table table-hover responsive">
                        ...
                        <tbody>
                        <?php
                        $tampil=mysql_query("SELECT * FROM tblrealisasi r JOIN tblpengunjung s ON ( s.id_pengunjung = r.id_pengunjung ) 
                        WHERE tglpenjualan BETWEEN  '$_POST[tglpenjualanaw]' AND  '$_POST[tglpenjualanak]'
                        ORDER BY nopenjualan ASC");
                        $no = 1;
                          while ($r=mysql_fetch_array($tampil)){
                        ...
                        $liatHarga=mysql_fetch_array(mysql_query("SELECT sum(total_penjualan) as total_penjualan FROM tblrealisasi
