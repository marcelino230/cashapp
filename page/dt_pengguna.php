...
<section class="content">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>Delete</th>
                            ...
                            <tbody>
                            <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT users.*,akses_user.* FROM users JOIN akses_user ON users.id_akses=akses_user.id_akses
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                 $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO users (idusers,username,password,id_akses) VALUES ('','$_POST[username]',
...
<section class="content">
  <div class="row">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    <div class="form-group">
                        ...
                        $result=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from akses_user");
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
 $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM users WHERE idusers='$_GET[id]'"));
            if (isset($_POST['update'])) {

            if (empty($_POST['password'])) {

                mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE users SET username='$_POST[username]',
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM users WHERE idusers='$_GET[id]'");
      echo "<script>window.location='home.php?pg=pggna&act=view'</script>";
      break;
