...
<section class="content">
    ...
    <a href="?pg=kssm&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysql_query("SELECT * FROM tblpengunjung order by id_pengunjung asc");
                    $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysql_query("INSERT INTO tblpengunjung VALUES ('','$_POST[noktp]',
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysql_fetch_array(mysql_query("SELECT * FROM tblpengunjung WHERE id_pengunjung='$_GET[id]'"));
            if (isset($_POST['update'])) {
              mysql_query("UPDATE tblpengunjung SET noktp='$_POST[noktp]', 
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA pengunjung //
      case 'delete':
      mysql_query("DELETE FROM tblpengunjung WHERE id_pengunjung='$_GET[id]'");
      echo "<script>window.location='home.php?pg=kssm&act=view'</script>";
      break;
