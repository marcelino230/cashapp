    ...
    <a href="?pg=rls&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblrealisasi r  join tblpengunjung s 
      ...
      if (isset($_POST['add'])) {
        ...
        if ($harga >= 10000000){
          $isv_sales = 30000;
                ...
                $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tblrealisasi VALUES ('$_POST[nopenjualan]',
                '$_POST[tglpenjualan]',
...
<section class="content">
  <div class="row">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      $sql = mysqli_query($GLOBALS["___mysqli_ston"], "select * from tblrealisasi");
                    ...
                    <div class="form-group">
                      ...
                      <?php
                      $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblpengunjung ORDER BY id_pengunjung");
                      while($r=mysqli_fetch_array($tampil)){
                      ?>
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblrealisasi WHERE nopenjualan='$_GET[id]'"));
            ...
            if ($harga >= 10000000){
              ...
              mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tblrealisasi SET tglpenjualan='$_POST[tglpenjualan]',id_pengunjung='$_POST[id_pengunjung]',
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA REALISASI //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tblrealisasi WHERE nopenjualan='$_GET[id]'");
      echo "<script>window.location='home.php?pg=rls&act=view'</script>";
      break;
