...
<section class="content">
    ...
    <a href="?pg=krywn&act=add"> <button type="button" class="btn btn-primary"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblkaryawan k join level_user l
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO tblkaryawan VALUES ('','$_POST[jabatan]',
...
<section class="content">
  <div class="row">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <?php
                      $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblpendidikan ORDER BY id_pendidikan");
                      while($r=mysqli_fetch_array($tampil)){
                      ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php
                      $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM level_user where level not like 'admin%' ORDER BY id_level");
                      while($r=mysqli_fetch_array($tampil)){
                      ?>
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tblkaryawan WHERE id_karyawan='$_GET[id]'"));
            if (isset($_POST['update'])) {          
              mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE tblkaryawan SET nmkaryawan='$_POST[nmkaryawan]',
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA KARYAWAN //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM tblkaryawan WHERE id_karyawan='$_GET[id]'");
      echo "<script>window.location='home.php?pg=krywn&act=view'</script>";
      break;
